...
describe("equals", () => {
  ...
  test("can test equality (against null/undefined)", () => {
    // This case is quite relevant because refs can be null
    // at any point in the document (and it's perfectly ok).
    // It just means that the char was inserted at the head,
    // even though (since then) other chars have been inserted on its left.
    // This case occurs at the method RGA.scan.
